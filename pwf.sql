...
-- Membuang struktur basisdata untuk metopen2_db
CREATE DATABASE IF NOT EXISTS `metopen2_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `metopen2_db`;

-- membuang struktur untuk table metopen2_db.cache
...
-- membuang struktur untuk table metopen2_db.cache_locks
...
-- membuang struktur untuk table metopen2_db.dosens
...
-- membuang struktur untuk table metopen2_db.failed_jobs
...
-- membuang struktur untuk table metopen2_db.jobs
...
-- membuang struktur untuk table metopen2_db.job_batches
...
-- membuang struktur untuk table metopen2_db.mahasiswas
...
-- membuang struktur untuk table metopen2_db.migrations
...
-- membuang struktur untuk table metopen2_db.password_reset_tokens
...
-- membuang struktur untuk table metopen2_db.pengaduans
...
-- membuang struktur untuk table metopen2_db.sessions
...
-- membuang struktur untuk table metopen2_db.tanggapans
CREATE TABLE IF NOT EXISTS `tanggapans` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `tanggapans_user_id_foreign` (`user_id`),
  CONSTRAINT `tanggapans_pengaduan_id_foreign` FOREIGN KEY (`pengaduan_id`) REFERENCES `pengaduans` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tanggapans_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table metopen2_db.users
